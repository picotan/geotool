...
pub mod geometry_core {
    ...
    impl LatLon {
        //    #[no_mangle]
        pub extern fn new(lat: f64, lon: f64) -> LatLon {
        ...
        #[unsafe(no_mangle)]
        pub extern fn LatLon(lat: f64, lon: f64) -> LatLon {
            LatLon::new(lat, lon)
        }

        #[unsafe(no_mangle)]
        pub extern fn latlon(coord: MapCoord) -> LatLon {
            LatLon::new(( (1f64 - coord.v)).tanh().asin() * 180f64 / PI, coord.u * 360f64 - 180f64)
        }

        #[unsafe(no_mangle)]
        pub extern fn coord(&self) -> MapCoord {
        ...
        pub extern fn distance(self: &Self, target: &LatLon) -> f64 {
        ...
        #[unsafe(no_mangle)]
        pub extern fn direction(self, point: &LatLon) -> f64 {
    ...
    impl Area {
        ...
        #[unsafe(no_mangle)]
        pub extern fn enter(self: &mut Self, location: &LatLon) {
        ...
        #[unsafe(no_mangle)]
        pub extern fn add(self: &mut Self, area: &Area) {
        ...
        #[unsafe(no_mangle)]
        pub extern fn is_in(self: &Self, area: &Area) -> bool {
    ...
    impl TileCoord {
        #[unsafe(no_mangle)]
        pub extern fn latlon_from_tile(&self) -> LatLon {
        ...
        #[unsafe(no_mangle)]
        pub extern fn tile_from_latlon(l: &LatLon, z: u32) -> TileCoord {
            let c = l.coord();
    ...
    impl Geometry {
//        #[no_mangle]
        pub extern fn horizontal_distance(&self, p: &Geometry) -> f64 {
        ...
        #[unsafe(no_mangle)]
        pub extern fn distance(&self, p: &Geometry) -> f64 {
        ...
        #[unsafe(no_mangle)]
        pub extern fn per_mill(&self, p: &Geometry) -> f64 {
            let d = self.horizontal_distance(p);
