pub mod gpx_writer {
    ...
    impl Writer {
        pub extern fn new(name: &str) -> io::Result<Self> {
        ...
        #[unsafe(no_mangle)]
        pub extern fn Writer(name: &str) -> io::Result<Self> {
            Writer::new(name)
        }

        #[unsafe(no_mangle)]
        pub extern fn write_gpx(self: &mut Self, track: &Track) {
            let opt = Options {
            ...
            let _ = self.file.write(a.as_ref());
        }
